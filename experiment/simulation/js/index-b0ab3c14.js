import * as z from "https://cdn.jsdelivr.net/npm/d3@7/+esm";
import { Path as Bn } from "https://cdn.jsdelivr.net/npm/d3@7/+esm";
(function () {
...
st.prototype = ln.prototype = {
  ...
  on: function (t, n) {
    ...
    if (arguments.length < 2) {
      for (; ++o < s; )
        if ((i = (t = r[o]).type) && (i = Vn(e[i], t.name))) return i;
      return;
    }
    if (n != null && typeof n != "function")
      throw new Error("invalid callback: " + n);
    for (; ++o < s; )
      if ((i = (t = r[o]).type)) e[i] = Ft(e[i], t.name, n);
      else if (n == null) for (i in e) e[i] = Ft(e[i], t.name, null);
    return this;
  },
  copy: function () {
    var t = {},
...
function gt(t) {
  ...
  return (
    ...
    Xt.hasOwnProperty(n) ? { space: Xt[n], local: t } : t
  );
}
function qn(t) {
  return function () {
    var n = this.ownerDocument,
      e = this.namespaceURI;
    return e === vt && n.documentElement.namespaceURI === vt
      ? n.createElement(t)
...
function Qn(t) {
  typeof t == "function" ? (t = Jn(t)) : (t = fn(t));
...
function ne(t) {
  return this.select(t == null ? te : jn(typeof t == "function" ? t : pn(t)));
}
...
function oe(t) {
  return this.selectAll(
    t == null ? re : ie(typeof t == "function" ? t : pn(t)),
  );
}
function se(t) {
...
function ce() {
  return new x(this._enter || this._groups.map(dn), this._parents);
}
function lt(t, n) {
...
function le(t, n, e, r, i, o) {
  for (var s = 0, c, a = n.length, l = o.length; s < l; ++s)
    (c = n[s]) ? ((c.__data__ = o[s]), (r[s] = c)) : (e[s] = new lt(t, o[s]));
...
function he(t, n) {
  ...
  for (
    ...
    var u = r[l],
      ...
      Gn = (a[l] = new Array(h));
    e(u, f, g, S, Gn, p, n);
    for (var X = 0, nt = 0, Gt, Bt; X < d; ++X)
      if ((Gt = g[X])) {
        for (X >= nt && (nt = X + 1); !(Bt = S[nt]) && ++nt < d; );
        Gt._next = Bt || null;
      }
  }
...
function de() {
  return new x(this._exit || this._groups.map(dn), this._parents);
}
function ge(t, n, e) {
  var r = this.enter(),
    i = this,
...
function Oe(t, n, e) {
  return arguments.length > 1
    ? this.each(
        (n == null ? Me : typeof n == "function" ? De : Re)(t, n, e ?? ""),
      )
    : G(this.node(), t);
}
function G(t, n) {
...
function Be(t, n) {
  return arguments.length > 1
    ? this.each((n == null ? Le : typeof n == "function" ? Ge : He)(t, n))
    : this.node()[t];
}
function mn(t) {
...
function Ve(t, n) {
  return function () {
    (n.apply(this, arguments) ? _n : wn)(this, t);
  };
}
function qe(t, n) {
  var e = mn(t + "");
  ...
  return this.each((typeof n == "function" ? Ve : n ? Fe : Xe)(e, n));
}
function Ye() {
  this.textContent = "";
}
...
function ze(t) {
  return arguments.length
    ? this.each(t == null ? Ye : (typeof t == "function" ? Ue : We)(t))
...
function Ze(t) {
  return arguments.length
    ? this.each(t == null ? Ke : (typeof t == "function" ? Qe : Je)(t))
    : this.node().innerHTML;
}
function je() {
...
function or(t, n) {
  var e = typeof t == "function" ? t : un(t),
    r = n == null ? ir : typeof n == "function" ? n : At(n);
  return this.select(function () {
...
function wr(t, n) {
  return this.each((typeof n == "function" ? _r : yr)(t, n));
}
function* xr() {
  for (var t = this._groups, n = 0, e = t.length; n < e; ++n)
...
function j() {
  return new x([[document.documentElement]], vn);
}
function vr() {
  return this;
}
...
var K = 0.7,
  ...
  N = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",
  br = /^#([0-9a-f]{3,8})$/,
  Er = new RegExp(`^rgb\\(${H},${H},${H}\\)$`),
  Nr = new RegExp(`^rgb\\(${N},${N},${N}\\)$`),
  Cr = new RegExp(`^rgba\\(${H},${H},${H},${J}\\)$`),
  Ir = new RegExp(`^rgba\\(${N},${N},${N},${J}\\)$`),
  $r = new RegExp(`^hsl\\(${J},${N},${N}\\)$`),
  Tr = new RegExp(`^hsla\\(${J},${N},${N},${J}\\)$`),
  qt = {
    aliceblue: 15792383,
...
function Pr(t) {
  return (
    t instanceof tt || (t = Q(t)),
    t ? ((t = t.rgb()), new y(t.r, t.g, t.b, t.opacity)) : new y()
  );
}
function bt(t, n, e, r) {
  return arguments.length === 1 ? Pr(t) : new y(t, n, e, r ?? 1);
}
function y(t, n, e, r) {
...
St(
  ...
  bn(tt, {
    ...
    clamp() {
      return new y(D(this.r), D(this.g), D(this.b), ft(this.opacity));
    },
    displayable() {
      return (
        -0.5 <= this.r &&
...
function En(t) {
  ...
  if ((t instanceof tt || (t = Q(t)), !t)) return new b();
  ...
  return (
    c
      ? (n === o
        ...
        (s *= 60))
      : (c = a > 0 && a < 1 ? 0 : s),
    new b(s, c, a, t.opacity)
  );
}
function Mr(t, n, e, r) {
  return arguments.length === 1 ? En(t) : new b(t, n, e, r ?? 1);
}
function b(t, n, e, r) {
...
St(
  ...
  bn(tt, {
    ...
    clamp() {
      return new b(Qt(this.h), rt(this.s), rt(this.l), ft(this.opacity));
    },
    displayable() {
      return (
    ...
    formatHsl() {
      const t = ft(this.opacity);
      return `${t === 1 ? "hsl(" : "hsla("}${Qt(this.h)}, ${rt(this.s) * 100}%, ${rt(this.l) * 100}%${t === 1 ? ")" : `, ${t})`}`;
    },
  }),
);
function Qt(t) {
...
function Gr(t, n) {
  var e = (Et.lastIndex = wt.lastIndex = 0),
    r,
    i,
    o,
    s = -1,
    c = [],
    a = [];
  for (t = t + "", n = n + ""; (r = Et.exec(t)) && (i = wt.exec(n)); )
    ((o = i.index) > e &&
...
function Br(t) {
  ...
  return n.isIdentity ? Nt : In(n.a, n.b, n.c, n.d, n.e, n.f);
}
function Fr(t) {
  return t == null ||
    (it || (it = document.createElementNS("http://www.w3.org/2000/svg", "g")),
    it.setAttribute("transform", t),
    !(t = it.transform.baseVal.consolidate()))
    ? Nt
...
function $n(t, n, e, r) {
  ...
  function o(l, u, f, h, p, d) {
    if (l !== f || u !== h) {
      ...
      d.push({ i: g - 4, x: A(l, f) }, { i: g - 2, x: A(u, h) });
    } else (f || h) && p.push("translate(" + f + n + h + e);
  }
  function s(l, u, f, h) {
    l !== u
      ? (l - u > 180 ? (u += 360) : u - l > 180 && (l += 360),
        h.push({ i: f.push(i(f) + "rotate(", null, r) - 2, x: A(l, u) }))
      : u && f.push(i(f) + "rotate(" + u + r);
  }
  function c(l, u, f, h) {
    l !== u
      ? h.push({ i: f.push(i(f) + "skewX(", null, r) - 2, x: A(l, u) })
  ...
  return function (l, u) {
    ...
    return (
      ...
      (l = u = null),
      function (p) {
        for (var d = -1, g = h.length, S; ++d < g; ) f[(S = h[d]).i] = S.x(p);
        return f.join("");
      }
    );
  };
}
var Xr = $n(Br, "px, ", "px)", "deg)"),
  Vr = $n(Fr, ", ", ")", ")"),
  B = 0,
  q = 0,
  V = 0,
...
dt.prototype = An.prototype = {
  constructor: dt,
  restart: function (t, n, e) {
    if (typeof t != "function")
      throw new TypeError("callback is not a function");
    ((e = (e == null ? Mt() : +e) + (n == null ? 0 : +n)),
      !this._next &&
        Y !== this &&
        (Y ? (Y._next = this) : (ht = this), (Y = this)),
      (this._call = t),
      (this._time = e),
      Ct());
  },
...
function Ct(t) {
  if (!B) {
    ...
    var n = t - O;
    n > 24
      ? (t < 1 / 0 && (q = setTimeout(tn, t - Z.now() - mt)),
        V && (V = clearInterval(V)))
      : (V || ((pt = Z.now()), (V = setInterval(Wr, Tn))), (B = 1), kn(tn));
  }
}
function nn(t, n, e) {
  var r = new dt();
...
var zr = ln("start", "end", "cancel", "interrupt"),
  Kr = [],
  Pn = 0,
  en = 1,
  It = 2,
...
function Rt(t, n) {
  var e = E(t, n);
  if (e.state > Pn) throw new Error("too late; already scheduled");
  return e;
}
function C(t, n) {
  var e = E(t, n);
...
function Jr(t, n, e) {
  ...
  function s(l) {
    ...
    if (
      ...
      for (
        e.state = ct, i = new Array((h = e.tween.length)), u = 0, f = -1;
        u < h;
        ++u
      )
    ...
    for (
      var u =
          l < e.duration
            ...
            : (e.timer.restart(a), (e.state = $t), 1),
        f = -1,
        h = i.length;
      ++f < h;
    )
      i[f].call(t, u);
    e.state === $t && (e.on.call("end", t, t.__data__, e.index, e.group), a());
  }
  function a() {
...
function ni(t, n) {
  ...
  if (((t += ""), arguments.length < 2)) {
    for (var r = E(this.node(), e).tween, i = 0, o = r.length, s; i < o; ++i)
...
function ai(t, n) {
  ...
  return this.attrTween(
    t,
    typeof n == "function"
      ? (e.local ? ci : si)(e, r, Dt(this, "attr." + t, n))
      : n == null
        ? (e.local ? ri : ei)(e)
        : (e.local ? oi : ii)(e, r, n),
  );
...
function pi(t, n) {
  ...
  var r = gt(t);
  return this.tween(e, (r.local ? fi : hi)(r, n));
}
function di(t, n) {
  return function () {
    Rt(this, t).delay = +n.apply(this, arguments);
  };
}
function gi(t, n) {
  return (
...
function wi(t) {
  var n = this._id;
  return arguments.length
    ? this.each((typeof t == "function" ? yi : _i)(n, t))
...
function vi(t) {
  var n = this._id;
  return arguments.length ? this.each(xi(n, t)) : E(this.node(), n).ease;
}
function bi(t, n) {
  return function () {
    var e = n.apply(this, arguments);
    ...
    for (var a = r[c], l = a.length, u, f = 0; f < l; ++f)
      if ((u = a[f])) {
        for (
          ...
          (p = h[g]) && yt(p, n, e, g, h, d);
        (o.push(h), s.push(u));
      }
  return new k(o, s, n, e);
}
var Mi = j.prototype.constructor;
function Ri() {
...
function Li(t, n, e) {
  ...
  return function () {
    var s = G(this, t),
      ...
      a = c + "";
    return (
      c == null && (a = c = (this.style.removeProperty(t), G(this, t))),
...
function Hi(t, n) {
  ...
  return function () {
    var a = C(this, t),
      l = a.on,
      u = a.value[o] == null ? c || (c = Mn(n)) : void 0;
    ((l !== e || i !== u) && (r = (e = l).copy()).on(s, (i = u)), (a.on = r));
  };
}
function Gi(t, n, e) {
  var r = (t += "") == "transform" ? Xr : Sn;
  return n == null
    ? this.styleTween(t, Di(t, r)).on("end.style." + t, Mn(t))
    : typeof n == "function"
      ? this.styleTween(t, Li(t, r, Dt(this, "style." + t, n))).each(
          Hi(this._id, t),
        )
      : this.styleTween(t, Oi(t, r, n), e).on("end.style." + t, null);
}
function Bi(t, n, e) {
  return function (r) {
...
var ji = { time: null, delay: 0, duration: 250, ease: Zi };
function to(t, n) {
...
function no(t) {
  ...
  t instanceof k
    ? ((n = t._id), (t = t._name))
    : ((n = Rn()), ((e = ji).time = Mt()), (t = t == null ? null : t + ""));
  for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
    for (var s = r[o], c = s.length, a, l = 0; l < c; ++l)
      (a = s[l]) && yt(a, t, n, l, s, e || to(a, n));
  return new k(r, this._parents, t, n);
}
j.prototype.interrupt = Zr;
j.prototype.transition = no;
function eo(t) {
...
W.prototype = {
  constructor: W,
  scale: function (t) {
    return t === 1 ? this : new W(this.k * t, this.x, this.y);
  },
  translate: function (t, n) {
    return (t === 0) & (n === 0)
      ? this
      : new W(this.k, this.x + this.k * t, this.y + this.k * n);
  },
  apply: function (t) {
...
class Dn {
  ...
  async load() {
    if (Vt("#" + this.id).node() != null) return;
    ...
    ((this.sensor = this.svgContainer
      ...
      .attr("id", this.id)),
      this.sensor.node().append(Vt(n.documentElement).node()));
  }
}
const L = [
    "connector0pin-0",
  ...
  so = (t) => {
    ...
    return (
      t.forEach((r) => {
        ...
        if (R[r.connector] == "GND") {
          e++;
          return;
        }
        if (R[r.connector].includes("GPIO")) {
          e++;
          return;
        }
      }),
...
class co {
  ...
  logConnectionsToHtml() {
    if (this.connections.length % 2 == 0) {
      ...
      const e = R[this.connections[this.connections.length - 2].connector]
          ? `${R[this.connections[this.connections.length - 2].connector]} pin of Raspberry Pi`
          : U[this.connections[this.connections.length - 2].connector]
            ? U[this.connections[this.connections.length - 2].connector]
            : this.connections[this.connections.length - 2].connector,
        r = R[this.connections[this.connections.length - 1].connector]
          ? `${R[this.connections[this.connections.length - 1].connector]} pin of Raspberry Pi`
          : U[this.connections[this.connections.length - 1].connector]
            ? U[this.connections[this.connections.length - 1].connector]
...
const m = document.getElementById("svg");
m || console.error("SVG container not found");
const Tt = (m == null ? void 0 : m.offsetWidth) || window.innerWidth,
  lo =
    (m != null && m.offsetTop
      ? window.innerHeight - m.offsetTop
      : window.innerHeight) || 400,
  uo = window.innerWidth < 850,
  on = {
    desktop: {
      raspberry: { scale: 1.2, x: 0, y: 20 },
      sensor: { scale: 2.5, x: 300, y: 35 },
    },
    mobile: {
      raspberry: { scale: 0.25, x: Tt * 0.1, y: 10 },
      sensor: { scale: 0.625, x: Tt * 0.4, y: 100 },
    },
  },
  _ = uo ? on.mobile : on.desktop,
  fo = Math.max(
    _.raspberry.x + 400 * _.raspberry.scale,
    _.sensor.x + 100 * _.sensor.scale,
  ),
  ho = Math.max(
    _.raspberry.y + 200 * _.raspberry.scale,
    _.sensor.y + 100 * _.sensor.scale,
  ),
  po = Math.max(Tt, fo + 50),
  go = Math.max(lo, ho + 50),
  w = z
    .select("#svg")
    .append("svg")
    .attr("id", "svgContainer")
    .attr("viewBox", `0 0 ${po} ${go}`)
...
window.addEventListener("resize", () => {
  const t = (m == null ? void 0 : m.offsetWidth) || window.innerWidth,
    n =
      (m != null && m.offsetTop
        ? window.innerHeight - m.offsetTop
        : window.innerHeight) || 400;
...
const sn = (t, n) => {
  ...
  Lt = w.append("g").attr("id", "pathsGroup"),
  On = document.getElementById("rasberryPi"),
  Ln = document.getElementById("sensor"),
  F = document.getElementById("displayInfo"),
  ot = document.getElementById("componentDescription"),
  kt = document.getElementById("undoButton"),
  T = document.getElementById("temperature");
T.disabled = !0;
T.style.opacity = "0.5";
const P = new co("connectionLog"),
  an = new ao("errorBox", "errorHeading", "errorText", "closeErrorBox");
let v,
  $ = 0,
  Ht = !1;
kt.addEventListener("click", () => {
  (P.undoLastConnection(), xo());
});
const wo = (t) => {
  ...
  xo = () => {
    if (v) {
      Lt.selectAll(`path[id^="path${$}"]`)
        .nodes()
        .forEach((e) => e.remove());
      const n = w.select(`#marker-start-${$}`);
      (n.empty() || n.remove(),
        (v = null),
    ...
    if (P.connections.length > 0) {
      const t = P.connections[P.connections.length - 1],
        n = t.lineID,
      ...
      (i.empty() || i.remove(),
        L.includes(t.connector) &&
          z.select(`#${t.connector}`).style("fill", "#9a916c"),
        t.connectorEnd &&
          L.includes(t.connectorEnd) &&
          z.select(`#${t.connectorEnd}`).style("fill", "#9a916c"),
        P.connections.pop(),
...
const vo =
  ...
  Hn = (t, n) => {
    (t.addEventListener("mouseover", () => {
      ((ot.innerHTML = n), (ot.style.display = "block"));
    }),
      t.addEventListener("mouseout", () => {
        ((ot.style.display = "none"), (ot.innerHTML = ""));
      }));
  };
Hn(On, vo);
Hn(Ln, bo);
const xt = (t) => L.includes(t.srcElement.id) || Ot.includes(t.srcElement.id);
w.on("dblclick", (t) => {
  const n = mo(t),
    e = n.x,
    r = n.y;
  if (xt(t) && !v) {
    ((v = new Bn()),
      v.moveTo(e, r),
      L.includes(t.srcElement.id)
        ? z.select(`#${t.srcElement.id}`).style("fill", "black")
        : cn(e, r, `marker-start-${$}`),
      P.addConnection({
        lineID: `path${$}`,
        x: e,
...
w.on("mouseover", (t) => {
  L.includes(t.srcElement.id)
    ? (F.innerHTML = R[t.srcElement.id])
    : Ot.includes(t.srcElement.id) &&
      (F.innerHTML = U[t.srcElement.id] || "DHT11 Sensor Connector");
});
w.on("mouseout", (t) => {
  (L.includes(t.srcElement.id) || Ot.includes(t.srcElement.id)) &&
    (F.innerHTML = "CONNECTOR INFO");
});
const Eo = () => {
  const t = document.getElementById("temperature").value;
  F.innerHTML = `Temperature: ${t}°C`;
};
T.addEventListener("input", () => {
  const t = parseInt(T.value);
  if (((F.innerHTML = `Temperature: ${t}°C`), Ht)) {
...
T.addEventListener("touchmove", (t) => {
  if (!T.disabled) {
    ...
    if (((F.innerHTML = `Temperature: ${n}°C`), Ht)) {
      const e = document.getElementById("tempChangeMessage");
      ((e.style.display = "block"),
        n > 70
          ? ((e.textContent = `WARNING: High temperature detected - ${n}°C`),
            (e.className = "warning"))
          : ((e.textContent = `Temperature updated to ${n}°C`),
            (e.className = "normal")),
        console.log(`Message set: ${e.textContent}`),
        setTimeout(() => {
          ((e.style.opacity = "0"),
            setTimeout(() => {
...
document.getElementById("codeSubmit").addEventListener("click", () => {
  const t = so(P.getConnectionLog());
  t === !0
    ? ((Ht = !0),
      (kt.disabled = !0),
      (kt.style.opacity = "0.5"),
      (T.disabled = !1),
      (T.style.opacity = "1"),
